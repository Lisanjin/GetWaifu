      ...
      var c = (s.MD5 = o.extend({
        ...
        _doProcessBlock: function (t, e) {
          ...
          (A = u(
            ...
            (C = u(
              C,
              (D = u(D, (z = u(z, A, C, D, _, 6, a[60])), A, C, S, 10, a[61])),
              z,
              A,
              d,
              15,
        ...
        var r = t,
          ...
          g = ((r.kdf = {}).OpenSSL = {
            execute: function (t, e, r, i) {
              i || (i = o.random(8));
              var n = h.create({ keySize: e + r }).compute(t, i),
      ...
      var e = t,
        ...
        f = (o.DES = n.extend({
          ...
          _doCryptBlock: function (t, e, r) {
            ...
            for (var i = 0; i < 16; i++) {
              for (
                var n = r[i], o = this._lBlock, s = this._rBlock, a = 0, c = 0;
                c < 8;
                c++
              )
                a |= h[c][((s ^ n[c]) & l[c]) >>> 0];
